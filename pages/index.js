      ...
      <Layout donde="work">
        <div id={ styles.proyectos }>
          ...
          <Link href="/proyectos/un-gusto-conocerte-marca" data-aos="fade-up">
            <video id={ styles.videougc} width="1600" autoPlay={true} loop={true} muted={true} webkit-playsinline={true} playsinline={true} style={{ borderRadius:"35px" }}><source src="/images/un-gusto-conocerte-marca/logo.webm" type="video/webm"/></video>
          </Link>
